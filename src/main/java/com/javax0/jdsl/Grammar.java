...
public class Grammar {
	/**
	 * Use this field to start a chain of calls when building a rule in the
	 * grammar.
	 */
	 ...
	 * @return
	 */
	public Analyzer kw(String... keywords) {
	...
	private void addAnalyzerFlattened(final ListAnalyzer listAnalyzer,
